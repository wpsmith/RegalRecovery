...
- Activity Being Tracked: Sobriety, Commitments, Affirmations, Journaling, Check-ins, Custom
...
- Freemium: Basic Commitments Pack, Basic Affirmations Pack, Basic Devotionals, Partner Content
- Premium (unlocked forever when purchased): More Commitments Packs, More Affirmations Packs, Premium Partner Content, Premium Devotionals
...
**7. Singular Static Tools**
- 3 Circles Tool — Visual mapping of inner/middle/outer circle behaviors
- Maintenance Plan
- Vision

**8. Notification Strategy** — Priority hierarchy, daily caps, intelligent batching, quiet hours

**9. Analytics Dashboard** — Trends and stats

**10. Premium Advanced Analytics Dashboard** — Deeper trends and recovery insights

**11. Recovery Chatbot** — AI-powered conversational support with crisis escalation
...
- View addict's data on a per-permission basis (default: no access; individual, category, or activity-level grants)
- Defaults: Spouse/Counselor/Coach see all; Accountability Partner/Sponsor see all except journal and financial
- Messaging with Spouse, Accountability Partner, Sponsor, Coach, Counselor only

**13. Branding** — Brand the app via configuration for complete white-labeling in private partner contexts
...
**15. Data Subject Rights (DSR)** — Export or delete all personal data

**16. Data Backup** — Backup data to iCloud, Google Drive, or Dropbox

**17. Quick Action Shortcuts** — OS-level shortcuts (Apple Action Button, Siri Shortcuts, Android App Shortcuts) for rapid access to key activities

**18. WebKit Content Filter Accountability** — On-device content filtering and screen accountability with AI classification and accountability reports to support contacts

**19. Panic Button with Biometric Awareness** — Enhanced emergency intervention using front-facing camera for self-awareness disruption and facial expression analysis for personalized intervention

**20. Therapist Portal** — Web-based dashboard for therapists/CSATs to manage clients, assign homework, monitor progress, and receive crisis alerts

**21. Guided Breathing and Grounding Exercises** — Purpose-built breathing and grounding exercises for urge interruption and emotional regulation

**22. Recovery Health Score** — Single holistic score (0-100) synthesizing all recovery data into a daily pulse check

**23. Achievement System and Gamification** — Milestone celebrations with digital sobriety coins, consistency achievements, content consumption gamification, and anonymous milestone sharing

**24. Superbill and LMN Generation** — In-app medical billing documents for HSA/FSA reimbursement and insurance submission

**25. Meeting Finder** — GPS-powered meeting search across SA, SAA, Celebrate Recovery, AA, and S-Anon with NextMeeting SA integration

**26. Messaging Integrations** — WhatsApp, Signal, and Telegram deep links for accountability broadcasts, support communications, and milestone sharing

**27. Offline-First Content and Low Data Mode** — Pre-downloadable content and reduced bandwidth mode for metered data plans

**28. Trigger-Based Geofencing** — Proactive location-aware recovery support with high-risk zone detection and safe zone recognition

**29. Screen Time and Digital Wellness** — iOS Screen Time / Android Digital Wellbeing integration with recovery-correlated insights and digital boundary tools

**30. Couples Recovery Mode** — Unified couples dashboard with shared goals, trust-rebuilding milestones, couples devotionals, communication exercises, and shared calendar

**31. Sleep Tracking Integration** — Apple Health / Google Fit sleep data with recovery correlation insights and poor-sleep risk alerts

**32. Voice Journal / Audio Entries** — Audio-first journaling preserving raw voice recordings alongside auto-generated transcripts

**33. Content Trigger Log** — Behavioral logging of user responses after content filter events for pattern analysis and Post-Mortem correlation

**34. Book Logging / Recovery Bookshelf** — Personal reading tracker with chapter notes, progress tracking, and stage-based recommendations

**35. Anonymous Recovery Stories** — Moderated library of user-submitted recovery testimonials filterable by addiction type, gender, stage, and faith background

**36. Assessment Tools** — Structured self-evaluation instruments including Family Impact Assessment, Denial Assessment, Addiction Severity Assessment, and Relationship Health Assessment

**37. Podcasts** — Curated recovery podcast directory with deep links to Apple Podcasts and Spotify

**38. External Links** — Vetted directory of recovery organizations, crisis hotlines, fellowships, and clinical resources

**39. Arousal Template** — Guided clinical tool based on Patrick Carnes' framework for understanding and reshaping sexual arousal patterns (therapist-recommended)

**40. Memory Verse Study and Quizzing** — Scripture memorization with verse packs, spaced repetition, and interactive quizzing in user's preferred Bible translation

**41. Spotify Integration** — In-app music playback control with activity-specific playlist suggestions and curated recovery playlists

**42. SAST-R (Sexual Addiction Screening Test)** — Validated 20-item clinical screening instrument by Patrick Carnes for baseline and periodic assessment
...
**Activity Being Tracked:** Sobriety, Commitments, Affirmations, Journaling, Emotional Journaling, Check-ins, Person Check-ins, Meetings, Step Work, Exercise, Nutrition, Mood, Gratitude, Calls, Prayer, Custom
...
**Description:** Structured journaling focused on identifying, expressing, and processing emotions healthily.
...
**Entry Fields:**
1. What emotion? — Feelings Wheel or emoji picker
2. Why? — Free-text (voice-to-text available)
3. Intensity — Slider 1-10 (range allows -1 to 15 for extremes)

Multiple entries per day allowed. Tracks patterns over time. Feeds into Tracking System.
...
- Visible to support network based on community permissions (default: excluded from sponsor/accountability partner view; included for spouse/counselor if permissions granted)
...
**Priority:** P0 (Must-Have) — *Upgraded from P2 Maintenance Plan*

**Description:** Interactive, data-driven relapse prevention plan. See detailed specification under Feature 20 (Structured Relapse Prevention Plan) in Section 4.8.
...
#### **FEATURE 8: Recovery Chatbot**

**Priority:** P3 (Premium Feature)

**Description:** AI-powered conversational support with crisis escalation.

**Summary:**
- AI chatbot fine-tuned on recovery literature
- Capabilities: answer recovery questions, encouragement during urges, coping strategies, generated prayers, tool recommendations, role-play difficult conversations
- Integration with user's data
- Escalation protocol: crisis detection → human contact
- Guardrails: cannot provide medical/legal advice
- Privacy: conversations encrypted, not used for training without consent
...
- Default: no one can see anything
- Individual, Category, or Activity-level permission grants
- Defaults: Spouse/Counselor/Coach → View all; Accountability Partner/Sponsor → View all except Journal and Financial
...
### 4.8 New Features from Competitive Analysis
...
- Content filtering included in **Recovery+ tier** (not available in Free or Recovery tiers)
- This positions Recovery+ as the premium tier that replaces Covenant Eyes ($18/month) at a lower price ($14.99/month) while offering dramatically more recovery functionality
- Standalone accountability products cost $9–$18/month; bundling this into Recovery+ makes the tier an obvious value proposition
...
- Revenue comes from client subscriptions: therapist-referred clients receive a 30-day free trial of Recovery+ (vs. 14-day for organic users)
...
- Available for Recovery and Recovery+ subscribers
...
- Cost to user: free with Recovery+ subscription; $29.99 one-time for Recovery tier users
...
**Description:** An interactive, data-driven relapse prevention plan that builds on the user's historical urge data, FASTER Scale patterns, 3 Circles mapping, and Post-Mortem analyses to create a living, personalized defense strategy. Replaces and expands the original static Maintenance Plan tool.
...
- Support network cannot see screen time data (too invasive; only the user and their therapist — if explicitly granted — see this data)
...
- Couple has different subscription tiers → Couples Mode available if at least one partner has Recovery+ tier; the other partner gets access to couples-specific features only (devotionals, exercises, shared goals)
...
- Sleep data not shared with support network by default — user can optionally include in therapist view
...
**Description:** A curated directory of recovery-related podcasts with deep links to Apple Podcasts and Spotify, enabling users to discover and listen to recovery content without leaving the recovery ecosystem mentally — even when they leave the app technically.

**User Stories:**

- As a **recovering user**, I want to find podcasts about sex addiction recovery, so that I can learn and be encouraged during commutes, workouts, and downtime
- As a **recovering user**, I want podcast recommendations based on my recovery stage and faith background, so that I'm not sorting through hundreds of irrelevant shows
- As a **recovering user**, I want to tap and go directly to a podcast in Apple Podcasts or Spotify, so that I can start listening immediately without searching

**Curated Podcast Directory:**

Organized by category with editorial descriptions and recommendations:
...
- Hope Restored (American Association of Christian Counselors) — Faith-based recovery stories
...
- **Browse by category:** Recovery, Faith, Mental Health, Partners, Spanish Language
- **Search:** Search podcast titles and descriptions
- **Deep links:** Each podcast entry has two buttons: "Open in Apple Podcasts" (using `podcast://` or `itms-podcasts://` URL scheme) and "Open in Spotify" (using `spotify:show:` URI)
- **Episode recommendations:** For key podcasts, curate 3-5 "start here" episodes with descriptions and direct episode deep links
- **New episode alerts (optional):** For podcasts the user follows, notify when new episodes are published (via RSS feed polling)
- **Personal notes:** User can add notes per podcast or per episode (e.g., "Episode 47 — amazing insight on shame cycles, discuss with sponsor")
- **Listening log:** Optional — user marks episodes as listened; feeds into book/content consumption achievements and Tracking System (Growth/Intellectual dimension)

**Spotify Integration (see also Feature: Spotify Integration):**
- If Spotify is the user's preferred platform, podcast deep links open directly in Spotify
- Podcast listening can be tracked alongside music listening in the Spotify integration

**Content Pipeline:**
- Launch with 15-20 curated podcasts with editorial descriptions
- Community submissions: users can suggest podcasts for inclusion (moderated review)
- Partner podcasts: recovery organizations can submit their podcasts for featured placement
...
**Description:** A curated, organized directory of vetted external resources — websites, organizations, hotlines, educational content, and partner organizations — that extend the user's recovery beyond the app. Serves as a "recovery yellow pages" with editorial context and trust indicators.

**User Stories:**

- As a **recovering user**, I want a trusted directory of recovery organizations, so that I can find additional support without wading through search results of unknown quality
- As a **recovering user**, I want quick access to crisis hotlines and emergency resources, so that I can get help beyond what the app provides when I need it most
- As a **new user**, I want to understand what organizations like SA, SAA, and Celebrate Recovery are, so that I can decide which community fits me
...
**12-Step Fellowships:**
- Sexaholics Anonymous (sa.org) — with description of SA-specific sobriety definition
- Sex Addicts Anonymous (saa-recovery.org) — with distinction from SA
- Sex and Love Addicts Anonymous (slaafws.org)
- S-Anon (sanon.org) — for partners/families
- Celebrate Recovery (celebraterecovery.com) — church-based, all addictions
- Alcoholics Anonymous (aa.org) — for co-occurring substance addiction

**Christian Recovery Organizations:**
- Pure Desire Ministries (puredesire.org)
- Bethesda Workshops (bethesdaworkshops.org)
- Begin Again Institute (beginagaininstitute.com)
- New Life Ministries (newlife.com)
- Faithful & True (faithfulandtrue.com)
...
**Educational:**
- Fight the New Drug (fightthenewdrug.org) — Porn's effects on brain, relationships, society
- Your Brain on Porn (yourbrainonporn.com) — Neuroscience of porn addiction
- Covenant Eyes blog — Articles on accountability and recovery

**For Partners:**
- Bloom for Women (bloomforwomen.com) — Betrayal trauma courses
...
- Each entry includes: organization name, URL (deep link to browser), brief editorial description (2-3 sentences), category tags, trust indicator (verified partner, community-recommended, or staff-curated), and a "Why this matters for recovery" note
- **Favorites:** User can save frequently accessed links
- **Recently visited:** History of tapped links (stored locally, clearable)
- **Report broken link:** Flag for maintenance if a URL stops working
- **Partner badge:** Organizations with formal Regal Recovery partnerships displayed with a partner badge
- Links open in the in-app browser (Safari/Chrome WebView) with a "Return to Regal Recovery" navigation bar, or in external browser (user preference in Settings)

**Integration Points:**

- Crisis links accessible from Emergency Tools overlay (always)
- CSAT finder linked from Therapist Portal onboarding and support network setup
- Meeting finder links supplement the in-app Meeting Finder for fellowships not yet integrated
- Links searchable from the main Resources search

---

#### **TOOL: Arousal Template**

**Priority:** P2

**Description:** A guided, clinical tool based on Patrick Carnes' arousal template framework that helps users identify, understand, and begin to reshape the constellation of thoughts, images, behaviors, sensory experiences, and emotional patterns that constitute their sexual arousal system. This is deep therapeutic work — designed to be completed with therapist guidance, not as a standalone self-help exercise.

**User Stories:**

- As a **recovering user**, I want to understand my arousal template, so that I can see how my addiction was shaped by early experiences and consciously work to reshape it
- As a **recovering user**, I want a structured framework for examining what triggers my arousal, so that I can bring specificity to my recovery work instead of just trying to "white-knuckle" through urges
- As a **counselor**, I want to guide my client through arousal template work within the app, so that the exercise is documented, trackable, and available for reference between sessions
- As a **recovering user**, I want this tool to be private and sensitive, so that I can be honest about deeply personal material without fear of exposure

**Clinical Foundation:**

Based on Patrick Carnes' definition: the arousal template is "the total constellation of thoughts, images, behaviors, sounds, smells, sights, fantasies, and objects that arouse us sexually." This template forms in early childhood (typically ages 5-8) and is shaped by family dynamics, cultural messaging, trauma, media exposure, religious background, and life experiences. In addiction, the template becomes distorted — sexualizing anger, shame, fear, power, and other emotions that were never intended to be part of healthy arousal.

**Guided Exercise Sections:**

**1. Early Influences (Ages 0-12)**
- "What messages did you receive about sex and sexuality growing up?"
- "What was your family's attitude toward bodies, nudity, affection?"
- "Were you exposed to sexual content or behavior at a young age? What happened?"
- "What emotions were present in your earliest sexual experiences or awareness?"
- Free-text responses with voice-to-text; Feelings Wheel available as reference

**2. Adolescent Development (Ages 12-18)**
- "How did your sexual awareness develop during adolescence?"
- "What role did pornography, media, or peers play in shaping what you found arousing?"
- "What emotions became connected to sexual arousal during this period?" (shame, secrecy, power, rebellion, comfort, escape, loneliness)
- "Were there experiences of abuse, exploitation, or boundary violations?"

**3. Current Arousal Map**
- "What thoughts, images, scenarios, or stimuli currently trigger sexual arousal for you?"
- Categorized input: Visual (what you see), Auditory (what you hear), Emotional (what you feel), Situational (circumstances), Relational (dynamics with others), Sensory (physical sensations)
- For each category: "Is this element healthy, distorted, or harmful?" (self-assessment with therapist review)

**4. Emotional Roots**
- "Which emotions have become sexualized in your arousal system?"
- Checklist: Anger, Shame, Fear, Loneliness, Boredom, Power, Control, Rejection, Abandonment, Inadequacy, Excitement/Risk, Comfort/Soothing, Numbness/Escape, Custom
- For each selected emotion: "How did this emotion become connected to sexual arousal? Can you trace it to a specific experience or pattern?"

**5. Escalation Patterns**
- "Has your arousal template changed or escalated over time?"
- "What content or behaviors did you seek early in your addiction vs. recently?"
- "Do you notice a pattern of needing more intensity, novelty, or risk to achieve the same arousal?"
- Timeline visualization: user plots their escalation trajectory

**6. Healthy Arousal Vision**
- "What does healthy sexual arousal look like for you?"
- "What elements of your current template are consistent with your values and faith?"
- "What elements need to be released, grieved, and replaced?"
- "What does God-honoring intimacy look like in your vision for your future?"

**Important Safeguards:**

- **Therapist-recommended:** The tool displays a prominent notice on first access: "Arousal template work is deep and potentially triggering. We strongly recommend completing this exercise with your therapist or counselor. If you don't have a therapist, consider connecting with one before beginning this work."
- **Therapist assignment:** Therapists can assign specific sections via the Therapist Portal, pacing the work appropriately
- **Privacy:** Arousal template data is the most sensitive data in the entire app:
  - Encrypted with a separate user-specific key (not the general app encryption)
  - Never included in support network data sharing — not visible to sponsor, spouse, or accountability partner under any circumstance
  - Visible to therapist ONLY if the user explicitly grants arousal template access (a separate, specific consent beyond general journal access)
  - Not included in data exports unless the user explicitly checks "Include arousal template" during export
  - Not backed up to cloud backup by default — user must explicitly enable
- **Triggering content warning:** Each section begins with: "This section may bring up difficult memories or emotions. If you feel overwhelmed, stop and use the breathing exercise or contact your therapist."
- **No AI analysis:** Arousal template content is never processed by the AI chatbot, used for content recommendations, or included in any automated analysis. This data is for the user and their therapist only.

**Integration Points:**

- Accessible from Tools navigation (clearly marked as "Advanced — Therapist Recommended")
- Assignable via Therapist Portal (section by section)
- Emotional roots data can inform FASTER Scale insights (which sexualized emotions correlate with relapse)
- Linked from Post-Mortem Analysis: "Which elements of your arousal template were activated during this episode?"
- Feeds into Relapse Prevention Plan (arousal template awareness as a defense strategy)
- Export as encrypted PDF for therapy sessions only
...
**Community & Sharing:**
- FR5.1: System shall allow users to send accountability broadcasts to support network
...
- FR6.2: System shall support monthly and annual subscription tiers
- FR6.3: System shall allow subscription management (upgrade, downgrade, cancel)
- FR6.4: System shall provide 7-day free trial for premium features
...
**Reliability:** 99.5% uptime, 95% push notification delivery, 99% data sync success, zero data loss, 100% streak accuracy across time zones

**Scalability:** 500,000 concurrent users, 10,000 writes/second, 50,000 API requests/minute
...
**Privacy:**
- All recovery data treated as sensitive personal data
- GDPR and CCPA compliance
- Machine-readable data export (JSON)
- Permanent deletion within 30 days (backups within 90 days)
- Location data only with explicit consent
- Explicit opt-in for analytics
- Granular privacy controls per support contact

**Usability:** iOS 15+, Android 10+, screen reader support, dynamic font sizing, dark mode, one-hand usability, 4.5:1 contrast ratio (WCAG AA)

**Compatibility:** Latest 2 versions of Chrome/Safari/Firefox/Edge, iPhone SE (2020)+, iPad 6th gen+, Android 2GB+ RAM, cross-device sync in <30 seconds

**Localization:** i18n framework from launch, English and Spanish, local date/time formats, fully translated UI, settings-based language switch

**Backup & Recovery:** Daily automated backups, 90-day retention, point-in-time recovery (24h), RTO: 4 hours, RPO: 1 hour

**Monitoring & Logging:** Error logging with stack traces, crash reporting, API response time monitoring, engagement metrics (DAU, MAU), anonymized logs (no PII)

---

### 5.3 Content Moderation Plan

**Automated Filtering:** Profanity/hate speech filter, keyword detection for self-harm/suicidal ideation with immediate escalation, spam/link detection, content flagging for manual review

**Community Reporting:** Report button on all community content, report categories, hidden pending review, reporter confirmation

**Manual Review:** Daily moderation queue (<24h response), trained moderators with recovery context, escalation path (Moderator → Community Manager → Clinical Advisor), appeals process

**Crisis Disclosure Protocol:** If self-harm or suicidal ideation detected: immediately display crisis resources, notify emergency contact, flag for priority human review

**Content Guidelines:** Published community guidelines, zero tolerance for explicit content/grooming/solicitation, context-sensitive for recovery language, custom affirmation review before community publication

**Moderation Staffing:** Volunteer moderators (2-3) + founding team at launch, part-time paid moderator as community grows, dedicated safety team at scale
...
Professional translation with cultural review for all UI strings (~500), onboarding flows, affirmations (by bilingual Christian counselor), scripture (established Spanish translations), journal prompts, notifications, error messages, crisis resources, and legal documents.
...
- Tier Distribution: Free 93%, Premium ($9.99) 5%, Premium + Chatbot ($20) 2%
...
Decoupled serverless architecture on AWS with Flutter clients (iOS, Android, Web), API Gateway + Cognito, Lambda functions (Go), DynamoDB, SQS/SNS event bus, and third-party integrations.

### 10.2 Technology Stack

| Layer | Technology | Rationale |
|---|---|---|
| Mobile | Flutter (Dart) | Single codebase for iOS, Android, and web |
| Backend Language | Go (preferred), Node.js (acceptable) | Fast Lambda cold starts, strong concurrency |
...
| Cache | DynamoDB Accelerator (DAX) | Microsecond read latency for hot data |
...
**Local Development:** LocalStack, Docker Compose, SAM CLI, Flutter hot reload, Makefile/Taskfile

**Estimated Monthly Cost (post-free-tier):** ~$12-38/month

### 10.3 Security & Privacy Architecture

- OAuth 2.0 + JWT tokens (15 min access, rotating refresh)
- RBAC: User, Spouse, Sponsor, Counselor, Admin
- Biometric authentication support
- AES-256 encryption at rest with field-level encryption for critical data
- TLS 1.3 minimum, certificate pinning
- Pre-launch penetration test, annual audit, bug bounty program
- Privacy by Design: data minimization, purpose limitation, user control, right to erasure, no data selling
