...
db.flags.insertMany([
  ...
  },
  {
    ...
    createdAt: ISODate("2026-01-01T00:00:00Z"),
    modifiedAt: ISODate("2026-03-31T00:00:00Z"),
    flagKey: "feature.profile-management",
    enabled: true,
    rolloutPercentage: 100,
  ...
  },
  {
    ...
    createdAt: ISODate("2026-01-01T00:00:00Z"),
    modifiedAt: ISODate("2026-03-31T00:00:00Z"),
    flagKey: "feature.content-resources",
    enabled: true,
    rolloutPercentage: 100,
    description: "Devotionals, affirmations, and prompts",
    tiers: [],
    tenants: [],
    platforms: [],
    minAppVersion: "",
  ...
  },
  {
    ...
    createdAt: ISODate("2026-01-01T00:00:00Z"),
    modifiedAt: ISODate("2026-03-31T00:00:00Z"),
    flagKey: "feature.commitments",
    enabled: true,
    rolloutPercentage: 100,
    description: "Personal commitments and habit tracking",
    tiers: [],
    tenants: [],
    platforms: [],
    minAppVersion: "",
  ...
  },
  {
    ...
    enabled: true,
    rolloutPercentage: 100,
    description: "Daily sobriety reflections",
    tiers: [],
    tenants: [],
    platforms: [],
    minAppVersion: "",
  ...
  },
  {
    ...
    createdAt: ISODate("2026-01-01T00:00:00Z"),
    modifiedAt: ISODate("2026-03-31T00:00:00Z"),
    flagKey: "activity.sobriety-commitment",
    enabled: true,
    rolloutPercentage: 100,
    description: "Sobriety commitment declaration",
    tiers: [],
    tenants: [],
    platforms: [],
    minAppVersion: "",
  ...
  },
  {
    ...
    createdAt: ISODate("2026-01-01T00:00:00Z"),
    modifiedAt: ISODate("2026-03-31T00:00:00Z"),
    flagKey: "activity.urge-logging",
    enabled: true,
    rolloutPercentage: 100,
    description: "Urge tracking and analysis",
    tiers: [],
    tenants: [],
    platforms: [],
    minAppVersion: "",
  ...
  },
  {
    ...
    createdAt: ISODate("2026-01-01T00:00:00Z"),
    modifiedAt: ISODate("2026-03-31T00:00:00Z"),
    flagKey: "activity.journaling",
    enabled: true,
    rolloutPercentage: 100,
    description: "Recovery journaling",
    tiers: [],
    tenants: [],
    platforms: [],
    minAppVersion: "",
  ...
  },
  {
    ...
    createdAt: ISODate("2026-01-01T00:00:00Z"),
    modifiedAt: ISODate("2026-03-31T00:00:00Z"),
    flagKey: "activity.faster-scale",
    enabled: true,
    rolloutPercentage: 100,
    description: "FASTER Scale self-assessment",
    tiers: [],
    tenants: [],
    platforms: [],
    minAppVersion: "",
  ...
  },
  {
    ...
    createdAt: ISODate("2026-01-01T00:00:00Z"),
    modifiedAt: ISODate("2026-03-31T00:00:00Z"),
    flagKey: "activity.check-ins",
    enabled: true,
    rolloutPercentage: 100,
    description: "Daily and evening check-ins",
    tiers: [],
    tenants: [],
    platforms: [],
    minAppVersion: "",
...
print("✓ Created 16 feature flags");

// =============================================================================
// SECTION 10: CONTENT LIBRARY (AFFIRMATIONS, DEVOTIONALS, PROMPTS)
// =============================================================================
